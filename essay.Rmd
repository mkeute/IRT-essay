...
```{r biserialcorplot, echo=FALSE, out.width="50%", fig.align = 'center', fig.cap="Tetrachoric intercorrelations between items."}
...
```{r itemlossplot, echo=FALSE, out.width="50%", fig.align = 'center', fig.cap="Mean 0-1-loss (proportion of incorrectly predicted responses) per item."}
...
For gender, the overall preferred model was the one with weak invariance (see Table \@ref(tab:migendertab)), while  and Table \@ref(tab:miagetab)). 
